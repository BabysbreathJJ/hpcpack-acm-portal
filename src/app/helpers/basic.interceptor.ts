...
import { BasicInterceptorSkipHeader } from '../services/api.service';
...
export class BasicInterceptor implements HttpInterceptor {
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        if (request.headers.has(BasicInterceptorSkipHeader)) {
            const headers = request.headers.delete(BasicInterceptorSkipHeader);
